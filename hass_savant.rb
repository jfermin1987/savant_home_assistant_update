    ...
    Thread.new do
      ...
      loop do
        begin
          ...
          p([:debug, :savant_stream_closed, e.class.to_s])
          shutdown!
          break
        rescue => e
  ...
  loop do
    ...
    Thread.new do
      begin
        ...
        # Hass initializer starts its own threads (EM + Savant listener). No need to join here.
        # This thread can return; the connection lifetime is managed by the Hass instance.
      rescue => e
