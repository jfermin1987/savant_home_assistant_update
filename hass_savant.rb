...
"
  ...
  def start_ws
    ...
    @hass_ws.on :open do |_event|
      ...
      # Connection is up; cancel any pending reconnect timer and reset backoff
      begin
  ...
  def schedule_reconnect
    ...
    delay = (@reconnect_delay || RECONNECT_MIN).to_f
    @reconnect_delay = [[delay * 2.0, RECONNECT_MAX].min, RECONNECT_MIN].max
  ...
  loop do
    ...
    Thread.new do
      begin
        ...
        Thread.current.join # keep thread alive
      rescue => e
